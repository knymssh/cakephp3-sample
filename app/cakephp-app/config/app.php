...
return [
    ...
    'Datasources' => [
        'default' => [
            ...
            'persistent' => false,
            'host' => env('DB_HOST', 'localhost'),  // mod
            /*
            ...
            'username' => env('DB_USER', 'my_app'), // mod
            'password' => env('DB_PASS', 'secret'), // mod
            'database' => env('DB_NAME', 'my_app'), // mod
            /*
             * You do not need to set this flag to use full utf-8 encoding (internal default since CakePHP 3.6).
             */
            //'encoding' => 'utf8mb4',
            'encoding' => env('DB_ENCODING', 'utf-8'), // mod
            'timezone' => env('DB_TIMEZONE', 'UTC'), // mod
            'flags' => [],
            'cacheMetadata' => true,
            'log' => false,
